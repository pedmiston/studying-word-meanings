...
```{r dog, fig.cap = ""}
dog <- "img/dog.png" %>% readPNG %>% rasterGrob(x = 0.6, width = 0.6)
grid.newpage()
grid.draw(dog)
grid.text("dog -->", x = 0.3,
          gp = gpar(fontfamily = "Consolas", fontsize = 20, fontface = "bold"))
```
...
grid.text("< sound picture congruence >",
          gp = gpar(fontfamily = "Consolas", fontsize = 12, fontface = "bold"))
```
